# Trains a gcncheb network  (use: python3 thisFileName datasetName) ex. dataset medium9_2
...
try:
    ...
    def noWallGraph(start_img, goal_img, imglen):
        ...
        return number_of_nodes, featurelist, edges_src, edges_dst
    ...
    for index,i in enumerate(test_index):
        ...
        #     if mb_idx == minibatch:
        #         batchActions()
    torch.save(net.state_dict(), "gcncheb-pred.pth")
